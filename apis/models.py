...
class Order(models.Model):
    ...
    instamojo_payment_id = models.CharField(max_length=70, null=True, blank=True)
    instamojo_payment_request_id = models.CharField(max_length=70, null=True, blank=True)
    instamojo_payment_long_url = models.TextField(null=True, blank=True)
    hotel = models.ForeignKey(Hotel, null=True, blank=True)
    hotel_branch = models.ForeignKey(HotelBranch, null=True, blank=True)
